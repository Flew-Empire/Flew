...
```shell
CUSTOM_TEMPLATES_DIRECTORY="/var/lib/flew/templates/"
```
...
```shell
mkdir /var/lib/flew/templates/sing-box
```
...
```
Now, restart your Flew and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart Flew.
