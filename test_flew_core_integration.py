#!/usr/bin/env python3
"""
Тестирование интеграции системы мониторинга трафика с Flew Core
"""
...
def test_admin_integration():
    ...
    print("🔧 Testing Flew Core Integration...")
...
def print_integration_examples():
    ...
    print("\n📚 Flew Core Integration Examples:")
    print("=" * 50)
    
    print("\n1. 🔄 Сброс всего трафика (Flew Core + внешний):")
    print("   POST /api/admin/usage/reset/admin1")
    print("   - Сбрасывает users_usage в Flew Core")
    print("   - Сбрасывает внешний трафик в Flew Panel")
    
    print("\n2. 📊 Получение общего использования:")
    print("   GET /api/admin/usage/admin1")
    print("   - Возвращает: Flew Core usage + External_traffic (в байтах)")
    ...
    print("   - Не затрагивает Flew Core users_usage")
    ...
    limit_ui_example = """   Flew UI может использовать:
...
def print_api_summary():
    ...
    endpoints = [
        ...
        ("GET /api/admin/usage/{username}", "Общее использование (Flew Core + внешний)"),
...
def main():
    ...
    print("🚀 Flew Core Integration Test Suite")
    print("=" * 40)
    ...
    if integration_ok and reset_ok and combined_ok:
        print("\n🎉 All tests passed! Flew Core integration ready!")
        print("\n📝 Next steps:")
        print("1. 🔄 Перезапустите Flew Panel")
        print("2. 🖥️  Откройте Flew UI")
